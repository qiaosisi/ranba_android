package com.example.nimei1.ranba.adapter;
...
import com.example.nimei1.ranba.bean.Song;
import com.example.nimei1.ranba.utils.DateUtils;

import java.util.List;


/**
 * Created by qy on 2018/6/27.
 * desc
 */
...
public class AudioAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.audioSize.setText(String.valueOf(song.getSize()));
